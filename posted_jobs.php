                    ...
                    <div class="col-lg-6 col-md-12 mb-4">
                        <div class="single-job-items mb-30">
                            ...
                            <div class="items-link items-link2 f-right">
                                ...
                                <a href="deactive_job.php?id=<?php echo $row['job_id'] ?>" class="btn btn-<?php echo $row['status'] === 'active' ? 'warning' : 'success'; ?> ml-2" onclick="return confirm('Are you sure you want to <?php echo $row['status'] === 'active' ? 'deactivate' : 'activate'; ?> this job?')">
                                    <i class="fas fa-<?php echo $row['status'] === 'active' ? 'pause' : 'play'; ?> mr-1"></i> <?php echo $row['status'] === 'active' ? 'Deactivate' : 'Activate'; ?>
                                </a>
                                <a href="delete_job.php?id=<?php echo $row['job_id'] ?>" class="btn btn-danger ml-2" onclick="return confirm('Are you sure you want to delete this job?')">
                                    <i class="fas fa-trash mr-1"></i> Delete
                                </a>
                            </div>
                            <div class="job-date mt-3">
                                <i class="far fa-calendar-alt mr-2"></i> Posted on: <?php echo date('F j, Y', strtotime($row['date'])) ?>
                            </div>
                        </div>
                    </div>
                    <?php
